        ...
        <div className="about">
            ...
            <div class="aboutContent">
                <div class="contentText">
                    ...
                    <p class="aboutText">J'ai le projet de créer  et utiliser une application de suivi pour l'apiculture et aussi de prévision des actions à réaliser.</p>
                </div>
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Gbczg095K_A?start=411" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <p><a className="linkSeed" href="https://seedoseed.site">Lien vers le site SeedoSeed ici</a></p>
                </div>
            </div>
            <Footer/>
        </div>
